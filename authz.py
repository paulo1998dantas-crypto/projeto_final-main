...
VIEW_AND_POINT_PERMISSIONS = frozenset({
    MES_DASHBOARD_READ,
    MES_STAGE_WRITE,
    MES_EXPORTS_READ,
})
...
ROLE_DEFAULT_PERMISSIONS = {
    ...
    "OPERADOR": VIEW_AND_POINT_PERMISSIONS,
    # O requisito funcional definiu o acesso MES do comprador como igual ao
    # do operador, inclusive os apontamentos dentro dos cards.
    "COMPRADOR": VIEW_AND_POINT_PERMISSIONS,
    "PCP": OPERATIONAL_MANAGEMENT_PERMISSIONS,
    "ENGENHARIA": OPERATIONAL_MANAGEMENT_PERMISSIONS,
